module Rebay
  class Shopping < Rebay::Api
    ...
    def build_request_url(service, params=nil)
      url = "#{Rebay::Api.base_url}?callname=#{service}&appid=#{Rebay::Api.app_id}&version=#{VERSION}&responseencoding=JSON&siteid=#{Rebay::Api::EBAY_US}&IncludeSelector=Description"
